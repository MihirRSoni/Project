...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="assets/index2.php" class="logo">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="assets/index.php"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li><a href="assets/index2.php"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <div class="box box-primary">
            ...
            <div class="box-footer">
              <ul class="mailbox-attachments clearfix">
                ...
                <li>
                  <span class="mailbox-attachment-icon has-img"><img src="assets/dist/img/photo1.png" alt="Attachment"></span>
                ...
                <li>
                  <span class="mailbox-attachment-icon has-img"><img src="assets/dist/img/photo2.png" alt="Attachment"></span>
